...
import z from 'zod';
import { makeListEvaluationUseCase } from '../../use-cases/factories/make-list-evaluation-use-case';
...
export class ListEvaluationController {
  async list(req: Request, res: Response): Promise<Response> {
    ...
    try {
      const getEvaluationsUseCase = makeListEvaluationUseCase();
